...
```mermaid
flowchart TB
  R[Regimen] --> P1[Pilar: seguridad]
  R --> P2[Pilar: justicia]
  R --> P3[Pilar: medios]
  R --> P4[Pilar: burocracia]
  R --> P5[Pilar: economía]
  R --> P6[Pilar: cultura/educación]
  M[Movimiento no violento] -->|deslegitima| P3
  M -->|retira cooperación| P4
  M -->|boicots/huelgas| P5
  M -->|quiebra miedo| P6
